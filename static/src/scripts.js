// The file used for the model was downloaded from this link:
// https://cgtrader.com/free-3d-models/interior/bedroom/another-bedroom

import { getObjectDict } from './dictionary.js';
import { getInfoDict } from './infoDict.js';

// put the path and name of room file here
const path = '../static/doc/';
...
var createScene = function () {
    ...
    BABYLON.SceneLoader.ImportMesh("", path, file, scene, function (meshes) {
        // Iterate through meshes and assign categories based on csv data
...
function assignCategories(mesh){
    // This setup allows for a more efficient data display when the user interacts with the model
...
function displayObjectInfo(objectName) {
    ...
    // Displays unknown if not in assigned categories
    ...
    // To be displayed to the right of the model
